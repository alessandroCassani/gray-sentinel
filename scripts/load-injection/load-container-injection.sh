...
JMETER_PATH="../../external/petclinic/spring-petclinic-api-gateway/src/test/jmeter"                         # Path to JMeter binary
...
TARGET_SERVICE="customers-service"           # Service to inject failure 
