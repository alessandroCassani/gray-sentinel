...
EXPERIMENT_RESULT=$(docker exec 03cb1d8b6a2e /opt/chaosblade-1.7.2/blade create disk burn --read --write --path "/" --size 20)
...
DESTROY_RESULT=$(docker exec 03cb1d8b6a2e /opt/chaosblade-1.7.2/blade destroy $EXPERIMENT_ID)
