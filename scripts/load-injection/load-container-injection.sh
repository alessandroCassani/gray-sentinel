...
EXPERIMENT_RESULT=$(docker exec 17832708a7b2 /opt/chaosblade-1.7.2/blade create cpu load --cpu-percent 90)
...
DESTROY_RESULT=$(docker exec 17832708a7b2 /opt/chaosblade-1.7.2/blade destroy $EXPERIMENT_ID)
