...
EXPERIMENT_RESULT=$(docker exec cfb27712026f /opt/chaosblade-1.7.2/blade create mem load --mode ram --mem-percent 80)
...
DESTROY_RESULT=$(docker exec cfb27712026f /opt/chaosblade-1.7.2/blade destroy $EXPERIMENT_ID)
