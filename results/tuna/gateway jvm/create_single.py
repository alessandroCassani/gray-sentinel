...
for metric_group, files in grouped_files.items():
    ...
    for file in sorted(files):
        try:
            ...
            cols_to_drop = [col for col in df.columns if col.lower() in ['time', 'timestamp']]
    ...
    if dfs:
        ...
        merged.to_csv(output_file, index=False)  # Sovrascrive se esiste già
...
if all_files:
    ...
    if final_dfs:
        ...
        final_merged.to_csv(final_output, index=False)  # Sovrascrive se esiste già
