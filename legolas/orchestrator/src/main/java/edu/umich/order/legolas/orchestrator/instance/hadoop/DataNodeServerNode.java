 ...
 *
 */
public final class DataNodeServerNode extends ServerNode {
    protected static String logFileName = null;
    public DataNodeServerNode(final MegaServer megaServer, final Orchestrator orchestrator,
    ...
    protected final String getLogFileName() {
        if (logFileName == null) {
            ...
            logFileName = "hadoop-" + userName + "-datanode-" + hostName + ".log";
        }
        return logFileName;
    }
